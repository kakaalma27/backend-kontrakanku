          ...
          <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
              <div class="avatar avatar-online">
                @if(isset($user) && $user->profile && $user->profile->image)
                <img src="{{ asset('storage/' . $user->profile->image) }}" alt class="w-px-40 h-auto rounded-circle" />
            @else
                <img src="{{ asset('assets/img/icons/misc/aviato.png') }}" alt class="w-px-40 h-auto rounded-circle" />
            @endif 
              </div>
            </a>
